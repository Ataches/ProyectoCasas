...
public class busqueda extends JFrame implements ActionListener{
	...
	JTextField tbaños = new JTextField(20);
	...
	void Main() {
		busqueda o = new busqueda(descp, ciudad, tipo, clase, estado);
		o.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		o.setSize(1100,900);
		o.setVisible(true);
	}

	busqueda(String descp, String ciudad, String tipo, String clase, String estado) {
		...
		lbaños.setBounds(50, 320+espaciado, 100, 23);
		c.add(tbaños);
		tbaños.setBounds(50, 340+espaciado, 100, 23);
		...
		resultado(descp, ciudad, tipo, clase, estado, prdesde, prhasta, 
				habs, antiguedad, mtdesde, mthasta, baños, deuda);
	}
	...
	resultado(String descp, String Ciudad, String Tipo, 
			...
			int habts, int antg, int mtsdesde, int mtshasta, int baño, String Deuda){
			...
			if(filtro = true){
				for (int j=1; j<=fila;j++){
					for(int i=3; i<=13;i++){
						...
						if(sdato.equals("")){}else{
							switch (i)
							{
							case 3://Ciudad	
								if ((Ciudad.equals("¿Ciudad?"))){}else{
									if (ciudad.equals(Ciudad)){}else{
							...
							case 5://Estado (nuevo)	
								...
								break;	
							case 6://Tipo (venta)	
								if ((Tipo.equals("¿En venta o arriendo?"))){}else{
									if (Tipo.equals(sdato)){}else{
										nobuscar[j]=1;
							...
							case 8://precio	
								...
								break;
							case 9://deuda	
								if(deuda.equals("")){}else{
									if ((sdato.equals(deuda))){}else{
										nobuscar[j]=1;
							...
							case 12://Baños	
								if ((baños != -1)){
									if (baño!=Integer.parseInt(sdato)){
										nobuscar[j]=1;

										System.out.println("sdato: "+sdato+" ciclo: "+j+" baños");
									}
								}
								break;	
							case 13://antiguedad
